                                      ...
                                      match.status_short !== "FT" ? (
                                        ...
                                        >
                                            ...
                                            >
                                              {match.odds?.find((odd) => odd.id === 25) && (
                                                <div>
                                                  ...
                                                  <div>
                                                    <span className="lblUnder">u</span>
                                                    <span className="border-dotted">
                                                      {safeParseFloat(
                                                        match.odds.find((odd) => odd.id === 25)
                                                          ?.values[1]?.odd
                                          ...
                                          <div className="flex items-center">
                                            <div className="club px-2 py-1 flex-1">
                                              <div className="flex flex-col">
                                                <span className="mb-1">{match.home_name}</span>
                                                <span className="mb-1">{match.away_name}</span>
                                                <span>{t("draw")}</span>
                                              </div>
                                            </div>
                                            <div
                                ...
                                <div key={`league-key-${l}`}>
                                  ...
                                  {league.fixtures.map((match, i) => (
                                    <div
                                      key={i}
                                      className={`border-b border-gray-200 ${
                                        i % 2 === 0 ? "even bg-gray-50" : "bg-white"
                                      }`}
                                    >
                                      {/* Full Match Row */}
                                      <div className="flex items-center">
                                        ...
                                        >
                                          {match.goal_ou && (
                                            <div>
                                              <div className="mb-1">
                                                <span>
                                                  {match.goal_ou[0]?.value.match(/[-+.\d]+/g) ?? "0"}
                                                </span>
                                                <span className="lblOver">o</span>
                                                <span className="border-dotted">
                                                  {safeParseFloat(match.goal_ou[0]?.odd)}
                                                </span>
                                              </div>
                                              <div>
                                                <span className="lblUnder">u</span>
                                                <span className="border-dotted">
                                                  {safeParseFloat(match.goal_ou[1]?.odd)}
                                                </span>
                                              </div>
                                            </div>
                                          )}
                                        ...
                                        >
                                          {match.full_1x2 && (
                                            <div className="flex flex-col">
                                              <span className="bg-full mb-2">
                                                {safeParseFloat(match.full_1x2[0]?.odd)}
                                              </span>
                                              <span className="bg-full mb-2">
                                                {safeParseFloat(match.full_1x2[2]?.odd)}
                                              </span>
                                              <span className="bg-full">
                                                {safeParseFloat(match.full_1x2[1]?.odd)}
                                              </span>
                                            </div>
                                          )}
                                        </div>
                                        ...
                                        >
                                          {match.goal_ou_1st && (
                                            <div>
                                              <div className="mb-1">
                                                <span>
                                                  {match.goal_ou_1st[0]?.value.match(/[-+.\d]+/g) ??
                                                    "0"}
                                                </span>
                                                <span className="lblOver">o</span>
                                                <span className="border-dotted">
                                                  {safeParseFloat(match.goal_ou_1st[0]?.odd)}
                                                </span>
                                              </div>
                                              <div>
                                                <span className="lblUnder">u</span>
                                                <span className="border-dotted">
                                                  {safeParseFloat(match.goal_ou_1st[1]?.odd)}
                                                </span>
                                              </div>
                                            </div>
                                          )}
                                          ...
                                          {match.half_1x2 && (
                                            <div className="flex flex-col">
                                              <span className="bg-full mb-1">
                                                {safeParseFloat(match.half_1x2[0]?.odd)}
                                              </span>
                                              <span className="bg-full mb-1">
                                                {safeParseFloat(match.half_1x2[2]?.odd)}
                                              </span>
                                              <span className="bg-full">
                                                {safeParseFloat(match.half_1x2[1]?.odd)}
                                              </span>
                                            </div>
                                          )}
                                        </div>
                        ...
                        <div className="page-highlight mt-2">
                          <div className="divide-y divide-gray-200">
                                  ...
                                  <div className="data-odds">
                                    <div className="data-odds-sub-header flex justify-between items-center bg-gray-100 p-2">
                                      <div
                                        ...
                                        style={{ width: "35%", paddingLeft: "25px" }}
                                      >
                                        <div className="xa">{t("time")}</div>
                                        <div className="xb px-3">{t("match")}</div>
                                      </div>
                                      <div
                                      ...
                                      >
                                        <div
                                          ...
                                          style={{ gap: "80px" }}
                                        >
                                          <div className="y1a">{t("handicap")}</div>
                                          <div className="y1b">{t("overUnder")}</div>
                                          <div className="y1c">{t("oneXTwo")}</div>
                                        </div>
                                        <div
                                          className="flex justify-between items-center"
                                          style={{ gap: "80px" }}
                                        >
                                          <div className="y2a">{t("handicap")}</div>
                                          <div className="y2b">{t("overUnder")}</div>
                                          <div className="y2c">{t("oneXTwo")}</div>
                                        </div>
                                      </div>
                                    </div>
                                                ...
                                                match.status_short !== "FT" && (
                                                  ...
                                                  >
                                                    <div className="flex justify-between items-center mb-2 w-full">
                                                      <div className="div1" style={{ width: "39%" }}></div>
                                                      <div className="div2" style={{ width: "28%" }}>
                                                        {t("fullMatch")}
                                                      </div>
                                                    ...
                                                    <div className="ttt flex flex-wrap -mx-4 w-full">
                                                      ...
                                                      <div
                                                        ...
                                                        style={{ paddingRight: "150px", paddingLeft: "100px" }}
                                                      >
                                                          ...
                                                          match.odds
                                                            ...
                                                            <>
                                                              <div className="text-right mb-1">
                                                                <span style={{ fontSize: "14px", fontWeight: "400" }}>
                                                                  {safeParseFloat(
                                                                    match.odds.find((odd) => odd.id === 33)?.values[0]
                                                                      ?.handicap
                                                                  )}
                                                                </span>
                                                                <span
                                                              ...
                                                              <div className="text-right">
                                                                ...
                                                                >
                                                                  {safeParseFloat(
                                                                    match.odds.find((odd) => odd.id === 33)?.values[1]
                                                                      ?.odd
                                                                  )}
                                                                </span>
                                                              </div>
                                                        ...
                                                        {match.odds?.find((odd) => odd.id === 25) && (
                                                          <>
                                                            <div className="text-right mb-1">
                                                              <span style={{ fontSize: "14px", fontWeight: "400" }}>
                                                                {safeParseFloat(
                                                                  match.odds.find((odd) => odd.id === 25)?.values[0]
                                                                    ?.handicap
                                                                )}
                                                              </span>
                                                              <span className="lblOver">o</span>
                                                            ...
                                                            <div className="text-right">
                                                              ...
                                                              >
                                                                {safeParseFloat(
                                                                  match.odds.find((odd) => odd.id === 25)?.values[1]
                                                                    ?.odd
                                                                )}
                                                              </span>
                                                            </div>
                                                      ...
                                                      <div className="flex-1 px-4 full-1x2 p-0">
                                                        {match.odds?.find((odd) => odd.id === 59) && (
                                                          <>
                                                            ...
                                                            >
                                                              {safeParseFloat(
                                                                match.odds.find((odd) => odd.id === 59)?.values[0]?.odd
                                                              )}
                                                            </span>
                                                            <span
                                                              className="bg-full mb-2"
                                                            ...
                                                            >
                                                              {safeParseFloat(
                                                                match.odds.find((odd) => odd.id === 59)?.values[2]?.odd
                                                              )}
                                                            </span>
                                                            <span
                                                              className="bg-full mb-2"
                                                            ...
                                                            >
                                                              {safeParseFloat(
                                                                match.odds.find((odd) => odd.id === 59)?.values[1]?.odd
                                                              )}
                                                            </span>
                                                          </>
                                                        )}
                                                          ...
                                                          match.odds
                                                            ...
                                                            <>
                                                              <div className="text-right mb-1">
                                                                <span style={{ fontSize: "14px", fontWeight: "400" }}>
                                                                  {safeParseFloat(
                                                                    match.odds.find((odd) => odd.id === 17)?.values[0]
                                                                      ?.handicap
                                                                  )}
                                                                </span>
                                                                <span
                                                              ...
                                                              <div className="text-right">
                                                                ...
                                                                >
                                                                  {safeParseFloat(
                                                                    match.odds.find((odd) => odd.id === 17)?.values[1]
                                                                      ?.odd
                                                                  )}
                                                                </span>
                                                              </div>
                                                        ...
                                                        {match.odds?.find((odd) => odd.id === 49) && (
                                                          <>
                                                            <div className="text-right mb-1">
                                                              <span style={{ fontSize: "14px", fontWeight: "400" }}>
                                                                {safeParseFloat(
                                                                  match.odds.find((odd) => odd.id === 49)?.values[0]
                                                                    ?.handicap
                                                                )}
                                                              </span>
                                                              <span className="lblOver">o</span>
                                                            ...
                                                            <div className="text-right">
                                                              ...
                                                              >
                                                                {safeParseFloat(
                                                                  match.odds.find((odd) => odd.id === 49)?.values[1]
                                                                    ?.odd
                                                                )}
                                                              </span>
                                                            </div>
                                                      ...
                                                      <div className="flex-1 px-4 half-1x2 p-0">
                                                        {match.odds?.find((odd) => odd.id === 19) && (
                                                          <>
                                                            ...
                                                            >
                                                              {safeParseFloat(
                                                                match.odds.find((odd) => odd.id === 19)?.values[0]?.odd
                                                              )}
                                                            </span>
                                                            <span
                                                              className="bg-full mb-2"
                                                            ...
                                                            >
                                                              {safeParseFloat(
                                                                match.odds.find((odd) => odd.id === 19)?.values[2]?.odd
                                                              )}
                                                            </span>
                                                            <span
                                                              className="bg-full mb-2"
                                                            ...
                                                            >
                                                              {safeParseFloat(
                                                                match.odds.find((odd) => odd.id === 19)?.values[1]?.odd
                                                              )}
                                                            </span>
                                                          </>
                                                        )}
                            ...
                            <div className="bbbb">
                              ...
                              >
                                <span className="font-semibold">{t("todayBookmakerOdds")}</span>
                                <span className="text-[28px] leading-[0] font-bold cursor-pointer">
                                                    ...
                                                    <div className="flex-1 px-4 half-ou p-0">
                                                      {match.goal_ou_1st && (
                                                        <>
                                                          <div className="text-right mb-1">
                                                            <span style={{ fontSize: "14px", fontWeight: "400" }}>
                                                              {match.goal_ou_1st[0]?.value.match(/[-+.\d]+/g) ?? "0"}
                                                            </span>
                                                            <span className="lblOver">o</span>
                                                            <span
                                                              className="border-dotted"
