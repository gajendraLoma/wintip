...
export default function BettingExperience() {
  const mainMatch = {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <section className="lg:col-span-3 space-y-8">
            <div className="bg-white px-4 md:px-8 py-6 max-w-[1280px] mx-auto">
              ...
              {/* Title & Description */}
              <h1 className="text-2xl font-bold mb-2">Betting Experience</h1>
              <p className="text-gray-700 mb-6">
                Betting Experience is a dedicated section for individuals who
                enjoy placing bets on various events, ranging from sports to
                entertainment. Here, you will find a plethora of information and
                resources to enhance your betting experience and help you make
                informed decisions. We cover everything from basic betting
                strategies to advanced techniques and tips for maximizing your
                profits. Our team of experts brings you the latest insights and
                trends from the world of betting, so you can stay ahead of the
                game.
              </p>
